...
namespace LocalAI.Api.Migrations
{
    ...
    [Migration("20260224043434_AdvancedRag")]
    partial class AdvancedRag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalAI.Api.Models.Document", b =>
                {
                    ...
                    b.HasIndex("ChunkLevel")
                        .HasDatabaseName("idx_document_level");
                    ...
                    b.HasIndex("ParentChunkId")
                        .HasDatabaseName("idx_document_parent");
            ...
            modelBuilder.Entity("LocalAI.Api.Models.MessageFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MessageId")
                        .HasDatabaseName("idx_feedback_message");
            ...
            modelBuilder.Entity("LocalAI.Api.Models.MessageFeedback", b =>
                {
                    b.HasOne("LocalAI.Api.Models.Message", "Message")
                        .WithMany()
